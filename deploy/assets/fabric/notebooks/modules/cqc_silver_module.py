...
def process_email_cdc(execution_data: dict[str, Any]) -> None:
...
def apply_reply_update_cdc(execution_data: dict[str, Any]) -> None:
    table_name = execution_data["table"]
